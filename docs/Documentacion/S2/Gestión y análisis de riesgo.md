...
| P7 | Se han asignado tareas repetidas a distintos miembros sin coordinación, provocando duplicidad de trabajo. | Sí | Se ha decidido enviar las tareas de forma más coordinada y definir claramente la "Definition of Done" en cada issue. | Número de tareas duplicadas por sprint → El objetivo es que este valor tienda a 0. |
